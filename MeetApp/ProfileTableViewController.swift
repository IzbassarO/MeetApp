...
class ProfileTableViewController: UITableViewController {
    ...
    @objc func editUserData() {
        ...
        user.about = aboutMeTextView.text ?? "A little about me"
    ...
    private func showEditOptions() {
        ...
        alertController.addAction(UIAlertAction(title: "Logout", style: .destructive, handler: { (alert) in
            self.logOutUser()
        }))
    ...
    private func updateUserWith(value: String) {
        if alertTextField.text != "" {
            ...
            ProgressHUD.failed("\(value) is empty")
        }
    }
            ...
            if uploadingAvatar {
                ...
                images.first!.resolve { (icon) in
                    ...
                    if icon != nil {
                        ...
                        ProgressHUD.failed("Couldn't select image!")
                    }
                }
            }
        } else {
